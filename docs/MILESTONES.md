...
Status 2026-09-16 (AD1): cel-shaded 3D selected by Ian as the final base rendering direction. Reusable foundation in `src/render/cel/` (palette, bands, families, lighting, fog, outline policy) integrated into normal Grassland; authoritative reference is `docs/ART_DIRECTION.md`. Third-person camera centers on the character and level-up releases the pointer lock (per Ian's instruction). Review evidence (4 contact sheets, 4 videos, style/performance/capture reports) is in `artifacts/art-direction/`. AD1.1 corrects the foundation in the same tree: sun 1.85, hemisphere 0.8, rim 0.65, STANDARD ramp 120/170/240, FLAT ramp 175/255, black grass vertex-color path removed; authored MMD albedo untouched. Evidence is 4 before/after contact sheets plus `ad1-1-correction.json/md`.

Director acceptance 2026-09-16 (AD1 + AD1.1): Ian reviewed the evidence and accepts cel-shaded 3D as final, posterized lighting without heavy outlines, Tololo's repaint-free presentation as foundation, corrected grass readability, third-person/ADS/top-down presentation, centered camera framing, level-up cursor behavior, and the unchanged aiming/crosshair/projectile/hit-volume behavior. Deferred, not final: grass color/density polish, cone-tree/scenery placeholders, provisional combat VFX, Tololo's preserved pale palette, Lade's temporary proxy, Medisin pending the Lade visual pipeline.
